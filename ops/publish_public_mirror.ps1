...
try {
    ...
    #   - ops/setup-gpu-sv-002.md・ops/codex-review-pack.md(2026-08-16 追加): 貸与サーバーの
    ...
    $leftPaths = (git log --all --name-only --format= ) -match '^(reference/2d-fire-sim|docs/|data/|env/|STATUS\.md|IMPLEMENTED\.md|PENDING\.md|ops/setup-gpu-sv-002\.md|ops/codex-review-pack\.md)'
    ...
    $idPattern = '10\.10\.0\.102|gpu-sv-002|tsukamoto@|152\.165\.117\.187'
