...
- 目的: AUTOMATA 第2回ハッカソン本選(**本選期間 8/8–8/23**)の事務局提出フォーム 3 設問への回答草案と、
...
> 本選期間中(8/8–8/23)で合計 約 200 時間(GPU 7 基をほぼ連続占有)/ 168GB(フル)**
...
> **フォームには「合計 約 200 時間」と書く**(GPU 開放 10 日 = 上限 240 時間の枠内。最大到達目標を狙いつつ
> 障害・再走の余白 40 時間を残す設計)。8/8–8/23 全期間(384h)が開放されるなら上限に余裕が出る。
>
...
| # | 項目 | なぜ未確定か |
|---|---|---|
| 1 | GPU 開放の実期間(10 日 か 8/8–8/23 全 16 日か) | 募集要項が「日程は仮」・フォームは 8/8–8/23。**事務局に確認が要る**。使用時間の申告値(200h)は 10 日=240h 前提 |
